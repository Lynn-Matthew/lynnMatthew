...
items.forEach(item => {
  ...
  const projectsData = [
    ...
    { id: 4, title: "Social Media Campaign", description: "Instagram and TikTok content series for summer collection launch with cohesive visual storytelling.", category: "Social Media Design", client: "Coastal Apparel", year: "2026", imageUrl: "https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=800&q=80", link: "#", galleryImages: ["profile.jpeg", "poster.png"] },
    { id: 5, title: "Restaurant Menu Design", description: "Elegant print menu and signage design for a Michelin-starred restaurant featuring custom illustrations.", category: "Print Design", client: "La Petite Maison", year: "2025", imageUrl: "https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=800&q=80", link: "#", galleryImages: ["profile.jpeg", "poster.png"] },
    
    { id: 6, title: "Brand Identity System", description: "Complete visual identity for a modern architecture studio.", category: "Print Design", client: "Studio Apex", year: "2025", imageUrl: "https://images.unsplash.com/photo-1545235617-7a424c1a60cc?w=800&q=80", link: "#", galleryImages: ["profile.jpeg", "poster.png"] },
    { id: 7, title: "Mobile Banking App", description: "Secure and intuitive banking experience for millennials.", category: "Development", client: "NeoBank", year: "2026", imageUrl: "https://images.unsplash.com/photo-1563986768609-322da13575f3?w=800&q=80", link: "#", galleryImages: ["profile.jpeg", "poster.png"] }
  ];
